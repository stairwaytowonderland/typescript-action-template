...
- [ ] **:four: Customize your _action_:**
  Customize the `README.md`, `CODEOWNERS`, `package.json` _(and `package-lock.json`)_, and `action.yaml` _files_ to
  include project-specific information and instructions.
